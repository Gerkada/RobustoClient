...
internal class MouseRotatorPatch
{
    ...
    {
        if (!RobustaConfig.RangedAimbotEnabled && !RobustaConfig.MeleeAimbotEnabled)
            return true;
        ...
        var aimSystem = entityManager.System<RobustaAimSystem>();
        ...
        var target = aimSystem.GetClosestInRange(mouseScreenPos, RobustaConfig.RangedAimbotRadius, exclude);
