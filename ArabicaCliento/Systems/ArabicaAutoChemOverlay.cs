...
using ArabicaCliento.Systems.AutoChem;

namespace ArabicaCliento.Systems;

public sealed class ArabicaAutoChemOverlay : Overlay
{
    private readonly IEntityManager _entMan;
    private readonly Font _font;
    private ArabicaAutoChemSystem? _autoChem;

    public override OverlaySpace Space => OverlaySpace.ScreenSpace;

    public ArabicaAutoChemOverlay()
    {
    ...
    {
        _autoChem ??= _entMan.System<ArabicaAutoChemSystem>();
